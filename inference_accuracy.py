...
if __name__ == "__main__":
    ...
    # model_indoor = MADNet(weight_path="results/indoor_accuracy_pretraining/best_model", image_shape=[640, 480], mode='NONE')
    # model_indoor = MADNet(weight_path="results/indoor_mate40p_accuracy_pretraining_static/best_model", image_shape=[640, 480], mode='NONE')
    # model_indoor = MADNet(weight_path="results/indoor_mate40p_accuracy_pretraining_static/weights", image_shape=[640, 480], mode='NONE')
    # model_indoor = MADNet(weight_path="results/indoor_mate40p_accuracy_pretraining_moving/best_model", image_shape=[640, 480], mode='NONE')
    ...
    for depth_folder, mode in product(depth_folders, modes):
        ...
        for _, (left_image_path, right_image_path) in enumerate(zip(left_image_paths, right_image_paths)):
            ...
            left_image = cv2.rectangle(left_image, (x, y), (x + w, y + h), (255, 0, 0), 2)
            disp_vis = cv2.rectangle(disp_vis, (x, y), (x + w, y + h), (255, 0, 0), 2)
            depth_map = cv2.rectangle(depth_map, (x, y), (x + w, y + h), (255, 0, 0), 2)
        ...
        with open(result_save_path, "w") as f:
            ...
            print(f"save to {result_save_path}")
